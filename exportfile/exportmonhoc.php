...
if (isset($submit)) {
    ...
    $pdf->SetTitle('Xuất file PDF Môn Học');
    $pdf->SetSubject('Xuất file PDF Môn Học');
    $pdf->SetKeywords('PDF, Môn học');
    ...
    $pdf->Cell(0, 10, 'Xuất file PDF Môn Học', 0, 1, 'C');
